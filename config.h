...
static const char col_cyan[]        = "#6666ea";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray2, "#6666ea", col_gray3 },
	[SchemeSel]  = { col_gray4, "#31313a", col_cyan },
	[SchemeStatus]  = { col_cyan, "#6666ea",  "#6666ea"  }, // Statusbar right {text,background,not used but cannot be empty}
	[SchemeTagsSel]  = { col_gray4, col_cyan,  "#000000"  }, // Tagbar left selected {text,background,not used but cannot be empty}
    [SchemeTagsNorm]  = { col_gray4, "#432275" ,  "#000000"  }, // Tagbar left unselected {text,background,not used but cannot be empty}
    [SchemeInfoSel]  = { col_gray4, "#31313a" ,  "#000000"  }, // infobar middle  selected {text,background,not used but cannot be empty}
...
static const Rule rules[] = {
	/* xprop(1):
	 *	WM_CLASS(STRING) = instance, Polybar
